...
try:
    ...
    if conexion: # Verificar si la conexión está abierta
        ...
        #todo - debo pasar las ponderaciones a listas, ya que antes estaban en diccionario y las keys eran los instrumentos, y ahora estas cagas de instrumentos se repiten y me cago toda la wea xD
