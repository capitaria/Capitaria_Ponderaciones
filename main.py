...
if numero_dia_semana <= 5:
    try:
        ...
        if conexion: # Verificar si la conexión está abierta
            ...
            func_ins_instrumento_path(conexion, insert_path) #* insert PSQL / py_rp_ponderaciones_path
            func_upd_path_instrumento(conexion, update_path) #* update PSQL / py_rp_ponderaciones_path
            ...
            func_upd_path_grupo(conexion,llenado_path_grupo) #* update PSQL / py_rp_ponderaciones_path
